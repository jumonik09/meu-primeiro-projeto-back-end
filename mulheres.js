...
conectaBancoDeDados() //estou chamando a funcao que conecta ao bancoDeDados
...
//PATCH corrigir (alterar um dado)
...
app.use(router.delete('/mulheres/:id',deletaMulher))//configurei a rota Delete /mullheres
